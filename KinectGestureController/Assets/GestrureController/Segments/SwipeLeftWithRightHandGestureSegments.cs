...
{
    public class SwipeLeftWithRightHandSegment1 : IRelativeGestureSegment
    {
    ...
    public class SwipeLeftWithRightHandSegment2 : IRelativeGestureSegment
    {
        public GesturePartResult CheckGesture(Body body)
        {
            //right hand infront of right elbow
    ...
    public class SwipeLeftWithRightHandSegment3 : IRelativeGestureSegment
    {
        public GesturePartResult CheckGesture(Body body)
        {
            //right hand infront of right elbow
